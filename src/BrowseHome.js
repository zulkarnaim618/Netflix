...
function BrowseHome(props) {
  ...
  return (
    <div className="browse" >
      ...
      <Nav selected="home" showSearchResult={showSearchResult} setShowSearchResult={setShowSearchResult} profileName={profileName} searchContent={searchContent} setSearchContent={setSearchContent}/>
      {!showSearchResult?
        <>
      {banner>0?
      ...
      {
        rowTitle.map(e =>
          <Row key={e.ID} id={e.ID} space="home" query={e.TITLE} reload={reload} setReload={setReload}/>
        )
      }
      </div>
      </>:
      <div className="search-result-div">
        <SearchContent selected="home" searchContent={searchContent} setSearchContent={setSearchContent}/>
      </div>
    }
