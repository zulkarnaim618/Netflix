...
function BrowseMovie(props) {
  ...
  return (
    <div className="browse" >
      ...
      <Nav selected="movie" showSearchResult={showSearchResult} setShowSearchResult={setShowSearchResult} profileName={profileName} searchContent={searchContent} setSearchContent={setSearchContent}/>
      {!showSearchResult?
        <>
      {banner>0?
      ...
      {
        rowTitle.map(e =>
          <Row key={e.ID} id={e.ID} space="movie" query={e.TITLE} reload={reload} setReload={setReload}/>
        )
      }
      </div>
      </>:
      <div className="search-result-div">
        <SearchContent selected="movie" searchContent={searchContent} setSearchContent={setSearchContent}/>
      </div>
    }
