...
function ContentS(props) {
  ...
  return (
    ...
    <div className="search-content-div" onClick={oncontentinfo} onMouseEnter={oncontenthover}>
    ...
    {openPlayPopup?<Play openPlayPopup={openPlayPopup} setOpenPlayPopup={setOpenPlayPopup} content_id={props.content_id} season_no={0} episode_no={0}/>:null}
    </>
  );
}
